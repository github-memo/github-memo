...
<title>건강 검진 도우미 회원 조회 결과</title>
<jsp:useBean id="dto" class="studuserpkg.StuduserDTO"/>
<jsp:useBean id="dao" class="studuserpkg.StuduserDAO"/>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<%! boolean isNotEmpty(String str) { if ((str == null) || str.equals("")) { return false; } return true; } %>
</head> <body>
<% boolean flag = dto.isVerified(); if (!flag) { response.sendRedirect("beanHome.html"); } else { %>
<header><h2>건강 검진 도우미 회원 조회 결과</h2></header>
<nav><ul><li><a href="beanLogout.jsp">로그아웃</a></li>
<li><a href="beanFind.jsp">검색</a></li></ul></nav>
<section> <fieldset class = "fset"><legend>검색 결과</legend>
<div style = "overflow-x : auto; overflow-y : auto;">
<table class = "ex1">
<tr> <th>아이디</th> <th>이름</th> <th>전화</th> <th>이메일</th> <th>취미 운동</th> </tr>
